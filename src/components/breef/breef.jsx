        ...
        <>
            <div className='w-full flex flex-col min-h-full mx-auto relative bg-black'>
                <header className="text-white conteiner px-0 border-b-[1px] border-[#FFFFFFB2]">
                    <nav className="flex px-[80px] justify-between items-center font-medium py-[24px] border-b-[1px] border-[#FFFFFFB2] text-white bg-black">
                        ...
                        <ul className="flex flex-col gap-y-[80px]">
                            ...
                            <li className="border-b-[1px] border-[#FFFFFF33] pb-[80px] flex justify-between">
                                ...
                                <div className="w-[720px]">
                                    ...
                                    <form action="">
                                        <input type="text" placeholder="Строительство, продажа товаров, услуги..." className="border-b-[1px] border-[#FFFFFF33] outline-none w-full bg-transparent pb-[15px] text-[30px] leading-[36px]" />
                                    </form>
                                </div>
                            </li>
                            <li className="border-b-[1px] border-[#FFFFFF33] pb-[80px] flex justify-between">
                            ...
                            <li className="border-b-[1px] border-[#FFFFFF33] pb-[80px] flex justify-between">
                                ...
                                <div className="w-[720px]">
                                    ...
                                    <form action="">
                                        <input type="text" placeholder="Блог, каталог, о компании..." className="border-b-[1px] border-[#FFFFFF33] outline-none w-full bg-transparent pb-[15px] text-[30px] leading-[36px]" />
                                    </form>
                                </div>
                            </li>
                            <li className="border-b-[1px] border-[#FFFFFF33] pb-[80px] flex justify-between">
                            ...
                            <li className="border-b-[1px] border-[#FFFFFF33] pb-[80px] flex justify-between">
                                ...
                                <div className="w-[720px]">
                                    ...
                                    <form action="">
                                        <input type="text" placeholder="Ссылка..." className="border-b-[1px] border-[#FFFFFF33] outline-none w-full bg-transparent pb-[15px] text-[30px] leading-[36px]" />
                                    </form>
                                </div>
                            </li>
                            <li className="border-b-[1px] border-[#FFFFFF33] pb-[80px] flex justify-between">
                            ...
                            <li className="pb-[80px] flex justify-between">
                                ...
                                <div className="w-[720px]">
                                    ...
                                    <form action="" className="w-full flex flex-col gap-y-[40px]">
                                        <input type="text" placeholder="Имя*" className="border-b-[1px] border-[#FFFFFF33] text-[30px] leading-[36px] tracking-[-1px] pb-[15px] bg-transparent text-dec outline-none" />
                                        <input type="text" placeholder="Название компании" className="border-b-[1px] border-[#FFFFFF33] text-[30px] leading-[36px] tracking-[-1px] pb-[15px] bg-transparent text-dec outline-none" />
                                        <input type="text" placeholder="Телефон*" className="border-b-[1px] border-[#FFFFFF33] text-[30px] leading-[36px] tracking-[-1px] pb-[15px] bg-transparent text-dec outline-none" />
