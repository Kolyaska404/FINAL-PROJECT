                            ...
                            <div className="border-b-[1px] border-[#FFFFFF33] pb-[80px] flex justify-between">
                                ...
                                <div className="w-[720px]">
                                    ...
                                    <ul className="grid grid-cols-3 grid-rows-2 gap-y-[30px] ">
                                        ...
                                        <input id="serv_2" name="service" type="radio" checked={formData.service === 'Дизайн лендинга'} value='Дизайн лендинга' onChange={handleChange} className={`cursor-pointer service hover:text-black hover:bg-[#D2FE67] active:text-[#00000099] active:bg-[#DDFE8D] transition-colors flex w-[220px] h-[220px] rounded-[100%] justify-center items-center border-[0.5px] border-white text-center underline uppercase font-medium text-h9 leading-[15px] px-[20px]`}></input>
                                        <input id="serv_3" name="service" type="radio" checked={formData.service === 'Дизайн лендинга'} value='Дизайн лендинга' onChange={handleChange} className={`cursor-pointer service hover:text-black hover:bg-[#D2FE67] active:text-[#00000099] active:bg-[#DDFE8D] transition-colors flex w-[220px] h-[220px] rounded-[100%] justify-center items-center border-[0.5px] border-white text-center underline uppercase font-medium text-h9 leading-[15px] px-[20px]`}></input>
                                        <input id="serv_4" name="service" type="radio" checked={formData.service === 'Дизайн лендинга'} value='Дизайн лендинга' onChange={handleChange} className={`cursor-pointer service hover:text-black hover:bg-[#D2FE67] active:text-[#00000099] active:bg-[#DDFE8D] transition-colors flex w-[220px] h-[220px] rounded-[100%] justify-center items-center border-[0.5px] border-white text-center underline uppercase font-medium text-h9 leading-[15px] px-[20px]`}></input>
                                        <input id="serv_5" name="service" type="radio" checked={formData.service === 'Дизайн лендинга'} value='Дизайн лендинга' onChange={handleChange} className={`cursor-pointer service hover:text-black hover:bg-[#D2FE67] active:text-[#00000099] active:bg-[#DDFE8D] transition-colors flex w-[220px] h-[220px] rounded-[100%] justify-center items-center border-[0.5px] border-white text-center underline uppercase font-medium text-h9 leading-[15px] px-[20px]`}></input>
                                        <input id="serv_6" name="service" type="radio" checked={formData.service === 'Дизайн лендинга'} value='Дизайн лендинга' onChange={handleChange} className={`cursor-pointer service hover:text-black hover:bg-[#D2FE67] active:text-[#00000099] active:bg-[#DDFE8D] transition-colors flex w-[220px] h-[220px] rounded-[100%] justify-center items-center border-[0.5px] border-white text-center underline uppercase font-medium text-h9 leading-[15px] px-[20px]`}></input>
                                    </ul>
                                </div>
                            </div>
                            <div className="border-b-[1px] border-[#FFFFFF33] pb-[80px] flex justify-between">
