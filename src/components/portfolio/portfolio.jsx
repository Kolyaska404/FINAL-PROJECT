    ...
    return (
        <>
            <div className='w-full flex flex-col min-h-full mx-auto relative'>
                <header className="uppercase bg-white text-black h-[820px]">
                ...
                <main className="pt-[150px] pb-[300px] border-b-[1px] border-[#F5F5F7B2]">
                    <div className="px-[80px] relative max-w-[1440px] mx-auto pb-[47px] pt-[20px] flex flex-col w-full">
                            ...
                            {PRODUCTS.map((block) => {
                                return (
                                    <a href="https://tailwindcss.com/docs/grid-template-columns" >
                                        <li key={block.id} className='flex flex-col items-center uppercase justify-center cursor-pointer'>
